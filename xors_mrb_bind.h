...
#define XMRB_def(s,c,n,f,a) mrb_define_module_function(s,c,n,f,a)
//#define XMRB_def(s,c,n,f,a) mrb_define_module_function(s,c,"x" n,f,a)
//#define XMRB_def(s,c,n,f,a) mrb_define_method(s,c,n,f,a)
...
void mrb_xors3d_bind(mrb_state *mrb, struct RClass *c){
	...
	XMRB_def(mrb,c,"CreateLine3D",mrb_xors3d_xCreateLine3D,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DOrigin",mrb_xors3d_xLine3DOrigin,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DAddNode",mrb_xors3d_xLine3DAddNode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DColor",mrb_xors3d_xLine3DColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DUseZBuffer",mrb_xors3d_xLine3DUseZBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DOriginX",mrb_xors3d_xLine3DOriginX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DOriginY",mrb_xors3d_xLine3DOriginY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DOriginZ",mrb_xors3d_xLine3DOriginZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DNodesCount",mrb_xors3d_xLine3DNodesCount,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DNodePosition",mrb_xors3d_xLine3DNodePosition,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DNodeX",mrb_xors3d_xLine3DNodeX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DNodeY",mrb_xors3d_xLine3DNodeY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DNodeZ",mrb_xors3d_xLine3DNodeZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DRed",mrb_xors3d_xLine3DRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DGreen",mrb_xors3d_xLine3DGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DBlue",mrb_xors3d_xLine3DBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line3DAlpha",mrb_xors3d_xLine3DAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetLine3DUseZBuffer",mrb_xors3d_xGetLine3DUseZBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteLine3DNode",mrb_xors3d_xDeleteLine3DNode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearLine3D",mrb_xors3d_xClearLine3D,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadBrush",mrb_xors3d_xLoadBrush,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateBrush",mrb_xors3d_xCreateBrush,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeBrush",mrb_xors3d_xFreeBrush,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushTexture",mrb_xors3d_xGetBrushTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BrushColor",mrb_xors3d_xBrushColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BrushAlpha",mrb_xors3d_xBrushAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BrushShininess",mrb_xors3d_xBrushShininess,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BrushBlend",mrb_xors3d_xBrushBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BrushFX",mrb_xors3d_xBrushFX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BrushTexture",mrb_xors3d_xBrushTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushName",mrb_xors3d_xGetBrushName,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BrushName",mrb_xors3d_xBrushName,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushAlpha",mrb_xors3d_xGetBrushAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushBlend",mrb_xors3d_xGetBrushBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushRed",mrb_xors3d_xGetBrushRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushGreen",mrb_xors3d_xGetBrushGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushBlue",mrb_xors3d_xGetBrushBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushFX",mrb_xors3d_xGetBrushFX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetBrushShininess",mrb_xors3d_xGetBrushShininess,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraFogMode",mrb_xors3d_xCameraFogMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraFogColor",mrb_xors3d_xCameraFogColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraFogRange",mrb_xors3d_xCameraFogRange,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraClsColor",mrb_xors3d_xCameraClsColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraProjMode",mrb_xors3d_xCameraProjMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraClsMode",mrb_xors3d_xCameraClsMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SphereInFrustum",mrb_xors3d_xSphereInFrustum,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraClipPlane",mrb_xors3d_xCameraClipPlane,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraRange",mrb_xors3d_xCameraRange,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraViewport",mrb_xors3d_xCameraViewport,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraCropViewport",mrb_xors3d_xCameraCropViewport,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateCamera",mrb_xors3d_xCreateCamera,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraProject",mrb_xors3d_xCameraProject,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraProject2D",mrb_xors3d_xCameraProject2D,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ProjectedX",mrb_xors3d_xProjectedX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ProjectedY",mrb_xors3d_xProjectedY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ProjectedZ",mrb_xors3d_xProjectedZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetViewMatrix",mrb_xors3d_xGetViewMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetProjectionMatrix",mrb_xors3d_xGetProjectionMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraZoom",mrb_xors3d_xCameraZoom,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetViewProjMatrix",mrb_xors3d_xGetViewProjMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Collisions",mrb_xors3d_xCollisions,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearCollisions",mrb_xors3d_xClearCollisions,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ResetEntity",mrb_xors3d_xResetEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityRadius",mrb_xors3d_xEntityRadius,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityBox",mrb_xors3d_xEntityBox,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityType",mrb_xors3d_xEntityType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCollided",mrb_xors3d_xEntityCollided,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CountCollisions",mrb_xors3d_xCountCollisions,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionX",mrb_xors3d_xCollisionX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionY",mrb_xors3d_xCollisionY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionZ",mrb_xors3d_xCollisionZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionNX",mrb_xors3d_xCollisionNX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionNY",mrb_xors3d_xCollisionNY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionNZ",mrb_xors3d_xCollisionNZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionTime",mrb_xors3d_xCollisionTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionEntity",mrb_xors3d_xCollisionEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionSurface",mrb_xors3d_xCollisionSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CollisionTriangle",mrb_xors3d_xCollisionTriangle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityType",mrb_xors3d_xGetEntityType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RenderPostEffect",mrb_xors3d_xRenderPostEffect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreatePostEffectPoly",mrb_xors3d_xCreatePostEffectPoly,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetFunctionAddress",mrb_xors3d_xGetFunctionAddress,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadFXFile",mrb_xors3d_xLoadFXFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeEffect",mrb_xors3d_xFreeEffect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEntityEffect",mrb_xors3d_xSetEntityEffect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetSurfaceEffect",mrb_xors3d_xSetSurfaceEffect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetBonesArrayName",mrb_xors3d_xSetBonesArrayName,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceBonesArrayName",mrb_xors3d_xSurfaceBonesArrayName,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectInt",mrb_xors3d_xSetEffectInt,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectInt",mrb_xors3d_xSurfaceEffectInt,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectFloat",mrb_xors3d_xSetEffectFloat,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectFloat",mrb_xors3d_xSurfaceEffectFloat,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectBool",mrb_xors3d_xSetEffectBool,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectBool",mrb_xors3d_xSurfaceEffectBool,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectVector",mrb_xors3d_xSetEffectVector,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectVector",mrb_xors3d_xSurfaceEffectVector,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectVectorArray",mrb_xors3d_xSetEffectVectorArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectVectorArray",mrb_xors3d_xSurfaceEffectVectorArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectMatrixArray",mrb_xors3d_xSurfaceEffectMatrixArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectFloatArray",mrb_xors3d_xSurfaceEffectFloatArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectIntArray",mrb_xors3d_xSurfaceEffectIntArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectMatrixArray",mrb_xors3d_xSetEffectMatrixArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectFloatArray",mrb_xors3d_xSetEffectFloatArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectIntArray",mrb_xors3d_xSetEffectIntArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateBufferVectors",mrb_xors3d_xCreateBufferVectors,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferVectorsSetElement",mrb_xors3d_xBufferVectorsSetElement,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateBufferMatrix",mrb_xors3d_xCreateBufferMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferMatrixSetElement",mrb_xors3d_xBufferMatrixSetElement,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferMatrixGetElement",mrb_xors3d_xBufferMatrixGetElement,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateBufferFloats",mrb_xors3d_xCreateBufferFloats,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferFloatsSetElement",mrb_xors3d_xBufferFloatsSetElement,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferFloatsGetElement",mrb_xors3d_xBufferFloatsGetElement,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferDelete",mrb_xors3d_xBufferDelete,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectMatrixWithElements",mrb_xors3d_xSetEffectMatrixWithElements,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectMatrix",mrb_xors3d_xSetEffectMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectMatrix",mrb_xors3d_xSurfaceEffectMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectMatrixWithElements",mrb_xors3d_xSurfaceEffectMatrixWithElements,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectEntityTexture",mrb_xors3d_xSetEffectEntityTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectTexture",mrb_xors3d_xSetEffectTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectTexture",mrb_xors3d_xSurfaceEffectTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceEffectMatrixSemantic",mrb_xors3d_xSurfaceEffectMatrixSemantic,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectMatrixSemantic",mrb_xors3d_xSetEffectMatrixSemantic,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteSurfaceConstant",mrb_xors3d_xDeleteSurfaceConstant,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteEffectConstant",mrb_xors3d_xDeleteEffectConstant,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearSurfaceConstants",mrb_xors3d_xClearSurfaceConstants,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearEffectConstants",mrb_xors3d_xClearEffectConstants,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEffectTechnique",mrb_xors3d_xSetEffectTechnique,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceTechnique",mrb_xors3d_xSurfaceTechnique,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ValidateEffectTechnique",mrb_xors3d_xValidateEffectTechnique,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEntityShaderLayer",mrb_xors3d_xSetEntityShaderLayer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityShaderLayer",mrb_xors3d_xGetEntityShaderLayer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetSurfaceShaderLayer",mrb_xors3d_xSetSurfaceShaderLayer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetSurfaceShaderLayer",mrb_xors3d_xGetSurfaceShaderLayer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXInt",mrb_xors3d_xSetFXInt,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXFloat",mrb_xors3d_xSetFXFloat,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXBool",mrb_xors3d_xSetFXBool,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXVector",mrb_xors3d_xSetFXVector,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXVectorArray",mrb_xors3d_xSetFXVectorArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXMatrixArray",mrb_xors3d_xSetFXMatrixArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXFloatArray",mrb_xors3d_xSetFXFloatArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXIntArray",mrb_xors3d_xSetFXIntArray,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXEntityMatrix",mrb_xors3d_xSetFXEntityMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXTexture",mrb_xors3d_xSetFXTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXMatrixSemantic",mrb_xors3d_xSetFXMatrixSemantic,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteFXConstant",mrb_xors3d_xDeleteFXConstant,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearFXConstants",mrb_xors3d_xClearFXConstants,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFXTechnique",mrb_xors3d_xSetFXTechnique,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateEmitter",mrb_xors3d_xCreateEmitter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterEnable",mrb_xors3d_xEmitterEnable,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterEnabled",mrb_xors3d_xEmitterEnabled,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterGetPSystem",mrb_xors3d_xEmitterGetPSystem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterAddParticle",mrb_xors3d_xEmitterAddParticle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterFreeParticle",mrb_xors3d_xEmitterFreeParticle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterValidateParticle",mrb_xors3d_xEmitterValidateParticle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterCountParticles",mrb_xors3d_xEmitterCountParticles,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterGetParticle",mrb_xors3d_xEmitterGetParticle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitterAlive",mrb_xors3d_xEmitterAlive,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ExtractAnimSeq",mrb_xors3d_xExtractAnimSeq,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadAnimSeq",mrb_xors3d_xLoadAnimSeq,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetAnimSpeed",mrb_xors3d_xSetAnimSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AnimSpeed",mrb_xors3d_xAnimSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Animating",mrb_xors3d_xAnimating,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AnimTime",mrb_xors3d_xAnimTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Animate",mrb_xors3d_xAnimate,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AnimSeq",mrb_xors3d_xAnimSeq,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AnimLength",mrb_xors3d_xAnimLength,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetAnimTime",mrb_xors3d_xSetAnimTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetAnimFrame",mrb_xors3d_xSetAnimFrame,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAutoFade",mrb_xors3d_xEntityAutoFade,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityOrder",mrb_xors3d_xEntityOrder,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeEntity",mrb_xors3d_xFreeEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CopyEntity",mrb_xors3d_xCopyEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PaintEntity",mrb_xors3d_xPaintEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityShininess",mrb_xors3d_xEntityShininess,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityPickMode",mrb_xors3d_xEntityPickMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityTexture",mrb_xors3d_xEntityTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityFX",mrb_xors3d_xEntityFX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetParent",mrb_xors3d_xGetParent,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFrustumSphere",mrb_xors3d_xSetFrustumSphere,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CalculateFrustumVolume",mrb_xors3d_xCalculateFrustumVolume,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityParent",mrb_xors3d_xEntityParent,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ShowEntity",mrb_xors3d_xShowEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"HideEntity",mrb_xors3d_xHideEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"NameEntity",mrb_xors3d_xNameEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEntityQuaternion",mrb_xors3d_xSetEntityQuaternion,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEntityMatrix",mrb_xors3d_xSetEntityMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAlpha",mrb_xors3d_xEntityAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityColor",mrb_xors3d_xEntityColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySpecularColor",mrb_xors3d_xEntitySpecularColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAmbientColor",mrb_xors3d_xEntityAmbientColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityEmissiveColor",mrb_xors3d_xEntityEmissiveColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityBlend",mrb_xors3d_xEntityBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAlphaRef",mrb_xors3d_xEntityAlphaRef,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAlphaFunc",mrb_xors3d_xEntityAlphaFunc,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateInstance",mrb_xors3d_xCreateInstance,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreezeInstances",mrb_xors3d_xFreezeInstances,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"InstancingAvaliable",mrb_xors3d_xInstancingAvaliable,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityWorld",mrb_xors3d_xGetEntityWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEntityWorld",mrb_xors3d_xSetEntityWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ScaleEntity",mrb_xors3d_xScaleEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PositionEntity",mrb_xors3d_xPositionEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MoveEntity",mrb_xors3d_xMoveEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TranslateEntity",mrb_xors3d_xTranslateEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RotateEntity",mrb_xors3d_xRotateEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TurnEntity",mrb_xors3d_xTurnEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PointEntity",mrb_xors3d_xPointEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AlignToVector",mrb_xors3d_xAlignToVector,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityDistance",mrb_xors3d_xEntityDistance,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMatElement",mrb_xors3d_xGetMatElement,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityClass",mrb_xors3d_xEntityClass,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityBrush",mrb_xors3d_xGetEntityBrush,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityX",mrb_xors3d_xEntityX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityY",mrb_xors3d_xEntityY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityZ",mrb_xors3d_xEntityZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityVisible",mrb_xors3d_xEntityVisible,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityScaleX",mrb_xors3d_xEntityScaleX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityScaleY",mrb_xors3d_xEntityScaleY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityScaleZ",mrb_xors3d_xEntityScaleZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityRoll",mrb_xors3d_xEntityRoll,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityYaw",mrb_xors3d_xEntityYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityPitch",mrb_xors3d_xEntityPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityName",mrb_xors3d_xEntityName,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CountChildren",mrb_xors3d_xCountChildren,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetChild",mrb_xors3d_xGetChild,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityInView",mrb_xors3d_xEntityInView,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FindChild",mrb_xors3d_xFindChild,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityMatrix",mrb_xors3d_xGetEntityMatrix,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityAlpha",mrb_xors3d_xGetEntityAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetAlphaRef",mrb_xors3d_xGetAlphaRef,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetAlphaFunc",mrb_xors3d_xGetAlphaFunc,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityRed",mrb_xors3d_xEntityRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGreen",mrb_xors3d_xEntityGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityBlue",mrb_xors3d_xEntityBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityShininess",mrb_xors3d_xGetEntityShininess,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityBlend",mrb_xors3d_xGetEntityBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEntityFX",mrb_xors3d_xGetEntityFX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityHidden",mrb_xors3d_xEntityHidden,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitiesBBIntersect",mrb_xors3d_xEntitiesBBIntersect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MountPackFile",mrb_xors3d_xMountPackFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"UnmountPackFile",mrb_xors3d_xUnmountPackFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"OpenFile",mrb_xors3d_xOpenFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadFile",mrb_xors3d_xReadFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WriteFile",mrb_xors3d_xWriteFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CloseFile",mrb_xors3d_xCloseFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FilePos",mrb_xors3d_xFilePos,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SeekFile",mrb_xors3d_xSeekFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FileType",mrb_xors3d_xFileType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FileSize",mrb_xors3d_xFileSize,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FileCreationTime",mrb_xors3d_xFileCreationTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FileCreationTimeStr",mrb_xors3d_xFileCreationTimeStr,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FileModificationTime",mrb_xors3d_xFileModificationTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FileModificationTimeStr",mrb_xors3d_xFileModificationTimeStr,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadDir",mrb_xors3d_xReadDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CloseDir",mrb_xors3d_xCloseDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"NextFile",mrb_xors3d_xNextFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CurrentDir",mrb_xors3d_xCurrentDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ChangeDir",mrb_xors3d_xChangeDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateDir",mrb_xors3d_xCreateDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteDir",mrb_xors3d_xDeleteDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CopyFile",mrb_xors3d_xCopyFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteFile",mrb_xors3d_xDeleteFile,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Eof",mrb_xors3d_xEof,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadByte",mrb_xors3d_xReadByte,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadShort",mrb_xors3d_xReadShort,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadInt",mrb_xors3d_xReadInt,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadFloat",mrb_xors3d_xReadFloat,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadString",mrb_xors3d_xReadString,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadLine",mrb_xors3d_xReadLine,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WriteByte",mrb_xors3d_xWriteByte,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WriteShort",mrb_xors3d_xWriteShort,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WriteInt",mrb_xors3d_xWriteInt,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WriteFloat",mrb_xors3d_xWriteFloat,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WriteString",mrb_xors3d_xWriteString,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WriteLine",mrb_xors3d_xWriteLine,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadFont",mrb_xors3d_xLoadFont,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Text",mrb_xors3d_xText,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetFont",mrb_xors3d_xSetFont,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeFont",mrb_xors3d_xFreeFont,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FontWidth",mrb_xors3d_xFontWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FontHeight",mrb_xors3d_xFontHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"StringWidth",mrb_xors3d_xStringWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"StringHeight",mrb_xors3d_xStringHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WinMessage",mrb_xors3d_xWinMessage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMaxPixelShaderVersion",mrb_xors3d_xGetMaxPixelShaderVersion,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Line",mrb_xors3d_xLine,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Rect",mrb_xors3d_xRect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RectsOverlap",mrb_xors3d_xRectsOverlap,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Viewport",mrb_xors3d_xViewport,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Oval",mrb_xors3d_xOval,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Origin",mrb_xors3d_xOrigin,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMaxVertexShaderVersion",mrb_xors3d_xGetMaxVertexShaderVersion,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMaxAntiAlias",mrb_xors3d_xGetMaxAntiAlias,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMaxTextureFiltering",mrb_xors3d_xGetMaxTextureFiltering,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetAntiAliasType",mrb_xors3d_xSetAntiAliasType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AppTitle",mrb_xors3d_xAppTitle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetWND",mrb_xors3d_xSetWND,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetRenderWindow",mrb_xors3d_xSetRenderWindow,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetTopWindow",mrb_xors3d_xSetTopWindow,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DestroyRenderWindow",mrb_xors3d_xDestroyRenderWindow,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Flip",mrb_xors3d_xFlip,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BackBuffer",mrb_xors3d_xBackBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LockBuffer",mrb_xors3d_xLockBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"UnlockBuffer",mrb_xors3d_xUnlockBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WritePixelFast",mrb_xors3d_xWritePixelFast,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadPixelFast",mrb_xors3d_xReadPixelFast,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetPixels",mrb_xors3d_xGetPixels,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SaveBuffer",mrb_xors3d_xSaveBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetCurrentBuffer",mrb_xors3d_xGetCurrentBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferWidth",mrb_xors3d_xBufferWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"BufferHeight",mrb_xors3d_xBufferHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CatchTimestamp",mrb_xors3d_xCatchTimestamp,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetElapsedTime",mrb_xors3d_xGetElapsedTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetBuffer",mrb_xors3d_xSetBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetMRT",mrb_xors3d_xSetMRT,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"UnSetMRT",mrb_xors3d_xUnSetMRT,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetNumberRT",mrb_xors3d_xGetNumberRT,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureBuffer",mrb_xors3d_xTextureBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadBuffer",mrb_xors3d_xLoadBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WritePixel",mrb_xors3d_xWritePixel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CopyPixel",mrb_xors3d_xCopyPixel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CopyPixelFast",mrb_xors3d_xCopyPixelFast,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CopyRect",mrb_xors3d_xCopyRect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GraphicsBuffer",mrb_xors3d_xGraphicsBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetColor",mrb_xors3d_xGetColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReadPixel",mrb_xors3d_xReadPixel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GraphicsWidth",mrb_xors3d_xGraphicsWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GraphicsHeight",mrb_xors3d_xGraphicsHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GraphicsDepth",mrb_xors3d_xGraphicsDepth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ColorAlpha",mrb_xors3d_xColorAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ColorRed",mrb_xors3d_xColorRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ColorGreen",mrb_xors3d_xColorGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ColorBlue",mrb_xors3d_xColorBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClsColor",mrb_xors3d_xClsColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearWorld",mrb_xors3d_xClearWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Color",mrb_xors3d_xColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Cls",mrb_xors3d_xCls,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"UpdateWorld",mrb_xors3d_xUpdateWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RenderEntity",mrb_xors3d_xRenderEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RenderWorld",mrb_xors3d_xRenderWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetAutoTB",mrb_xors3d_xSetAutoTB,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MaxClipPlanes",mrb_xors3d_xMaxClipPlanes,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Wireframe",mrb_xors3d_xWireframe,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Dither",mrb_xors3d_xDither,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetSkinningMethod",mrb_xors3d_xSetSkinningMethod,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TrisRendered",mrb_xors3d_xTrisRendered,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DIPCounter",mrb_xors3d_xDIPCounter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfRendered",mrb_xors3d_xSurfRendered,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityRendered",mrb_xors3d_xEntityRendered,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AmbientLight",mrb_xors3d_xAmbientLight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetFPS",mrb_xors3d_xGetFPS,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AntiAlias",mrb_xors3d_xAntiAlias,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetTextureFiltering",mrb_xors3d_xSetTextureFiltering,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"StretchRect",mrb_xors3d_xStretchRect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"StretchBackBuffer",mrb_xors3d_xStretchBackBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetDevice",mrb_xors3d_xGetDevice,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ReleaseGraphics",mrb_xors3d_xReleaseGraphics,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ShowPointer",mrb_xors3d_xShowPointer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"HidePointer",mrb_xors3d_xHidePointer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateDSS",mrb_xors3d_xCreateDSS,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteDSS",mrb_xors3d_xDeleteDSS,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GridColor",mrb_xors3d_xGridColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawGrid",mrb_xors3d_xDrawGrid,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawBBox",mrb_xors3d_xDrawBBox,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Graphics3D",mrb_xors3d_xGraphics3D,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GraphicsAspectRatio",mrb_xors3d_xGraphicsAspectRatio,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GraphicsBorderColor",mrb_xors3d_xGraphicsBorderColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetRenderWindow",mrb_xors3d_xGetRenderWindow,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Key",mrb_xors3d_xKey,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetEngineSetting",mrb_xors3d_xSetEngineSetting,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetEngineSetting",mrb_xors3d_xGetEngineSetting,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"HWInstancingAvailable",mrb_xors3d_xHWInstancingAvailable,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ShaderInstancingAvailable",mrb_xors3d_xShaderInstancingAvailable,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetShaderLayer",mrb_xors3d_xSetShaderLayer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetShaderLayer",mrb_xors3d_xGetShaderLayer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawMovementGizmo",mrb_xors3d_xDrawMovementGizmo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawScaleGizmo",mrb_xors3d_xDrawScaleGizmo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawRotationGizmo",mrb_xors3d_xDrawRotationGizmo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CheckMovementGizmo",mrb_xors3d_xCheckMovementGizmo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CheckScaleGizmo",mrb_xors3d_xCheckScaleGizmo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CheckRotationGizmo",mrb_xors3d_xCheckRotationGizmo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CaptureWorld",mrb_xors3d_xCaptureWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CountGfxModes",mrb_xors3d_xCountGfxModes,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GfxModeWidth",mrb_xors3d_xGfxModeWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GfxModeHeight",mrb_xors3d_xGfxModeHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GfxModeDepth",mrb_xors3d_xGfxModeDepth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GfxModeExists",mrb_xors3d_xGfxModeExists,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AppWindowFrame",mrb_xors3d_xAppWindowFrame,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Millisecs",mrb_xors3d_xMillisecs,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeltaTime",mrb_xors3d_xDeltaTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeltaValue",mrb_xors3d_xDeltaValue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AddDeviceLostCallback",mrb_xors3d_xAddDeviceLostCallback,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteDeviceLostCallback",mrb_xors3d_xDeleteDeviceLostCallback,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Deinit",mrb_xors3d_xDeinit,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageColor",mrb_xors3d_xImageColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageAlpha",mrb_xors3d_xImageAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageBuffer",mrb_xors3d_xImageBuffer,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateImage",mrb_xors3d_xCreateImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GrabImage",mrb_xors3d_xGrabImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeImage",mrb_xors3d_xFreeImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadImage",mrb_xors3d_xLoadImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadAnimImage",mrb_xors3d_xLoadAnimImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SaveImage",mrb_xors3d_xSaveImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawImage",mrb_xors3d_xDrawImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawImageRect",mrb_xors3d_xDrawImageRect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ScaleImage",mrb_xors3d_xScaleImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ResizeImage",mrb_xors3d_xResizeImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RotateImage",mrb_xors3d_xRotateImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageAngle",mrb_xors3d_xImageAngle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageWidth",mrb_xors3d_xImageWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageHeight",mrb_xors3d_xImageHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImagesCollide",mrb_xors3d_xImagesCollide,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageRectCollide",mrb_xors3d_xImageRectCollide,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageRectOverlap",mrb_xors3d_xImageRectOverlap,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageXHandle",mrb_xors3d_xImageXHandle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageYHandle",mrb_xors3d_xImageYHandle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"HandleImage",mrb_xors3d_xHandleImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MidHandle",mrb_xors3d_xMidHandle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AutoMidHandle",mrb_xors3d_xAutoMidHandle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TileImage",mrb_xors3d_xTileImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImagesOverlap",mrb_xors3d_xImagesOverlap,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MaskImage",mrb_xors3d_xMaskImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CopyImage",mrb_xors3d_xCopyImage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawBlock",mrb_xors3d_xDrawBlock,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawBlockRect",mrb_xors3d_xDrawBlockRect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageActualWidth",mrb_xors3d_xImageActualWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ImageActualHeight",mrb_xors3d_xImageActualHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FlushKeys",mrb_xors3d_xFlushKeys,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FlushMouse",mrb_xors3d_xFlushMouse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"KeyHit",mrb_xors3d_xKeyHit,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"KeyUp",mrb_xors3d_xKeyUp,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WaitKey",mrb_xors3d_xWaitKey,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseHit",mrb_xors3d_xMouseHit,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"KeyDown",mrb_xors3d_xKeyDown,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetKey",mrb_xors3d_xGetKey,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseDown",mrb_xors3d_xMouseDown,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseUp",mrb_xors3d_xMouseUp,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMouse",mrb_xors3d_xGetMouse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseX",mrb_xors3d_xMouseX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseY",mrb_xors3d_xMouseY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseZ",mrb_xors3d_xMouseZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseXSpeed",mrb_xors3d_xMouseXSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseYSpeed",mrb_xors3d_xMouseYSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseZSpeed",mrb_xors3d_xMouseZSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MouseSpeed",mrb_xors3d_xMouseSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MoveMouse",mrb_xors3d_xMoveMouse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyType",mrb_xors3d_xJoyType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyDown",mrb_xors3d_xJoyDown,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyHit",mrb_xors3d_xJoyHit,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetJoy",mrb_xors3d_xGetJoy,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FlushJoy",mrb_xors3d_xFlushJoy,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WaitJoy",mrb_xors3d_xWaitJoy,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyX",mrb_xors3d_xJoyX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyY",mrb_xors3d_xJoyY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyZ",mrb_xors3d_xJoyZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyU",mrb_xors3d_xJoyU,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyV",mrb_xors3d_xJoyV,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyPitch",mrb_xors3d_xJoyPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyYaw",mrb_xors3d_xJoyYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyRoll",mrb_xors3d_xJoyRoll,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyHat",mrb_xors3d_xJoyHat,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyXDir",mrb_xors3d_xJoyXDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyYDir",mrb_xors3d_xJoyYDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyZDir",mrb_xors3d_xJoyZDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyUDir",mrb_xors3d_xJoyUDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JoyVDir",mrb_xors3d_xJoyVDir,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CountJoys",mrb_xors3d_xCountJoys,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateLight",mrb_xors3d_xCreateLight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LightShadowEpsilons",mrb_xors3d_xLightShadowEpsilons,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LightEnableShadows",mrb_xors3d_xLightEnableShadows,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LightShadowsEnabled",mrb_xors3d_xLightShadowsEnabled,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LightRange",mrb_xors3d_xLightRange,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LightColor",mrb_xors3d_xLightColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LightConeAngles",mrb_xors3d_xLightConeAngles,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateLog",mrb_xors3d_xCreateLog,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CloseLog",mrb_xors3d_xCloseLog,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetLogString",mrb_xors3d_xGetLogString,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearLogString",mrb_xors3d_xClearLogString,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetLogLevel",mrb_xors3d_xSetLogLevel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetLogTarget",mrb_xors3d_xSetLogTarget,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetLogLevel",mrb_xors3d_xGetLogLevel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetLogTarget",mrb_xors3d_xGetLogTarget,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LogInfo",mrb_xors3d_xLogInfo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LogMessage",mrb_xors3d_xLogMessage,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LogWarning",mrb_xors3d_xLogWarning,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LogError",mrb_xors3d_xLogError,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LogFatal",mrb_xors3d_xLogFatal,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateMesh",mrb_xors3d_xCreateMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadMesh",mrb_xors3d_xLoadMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadMeshWithChild",mrb_xors3d_xLoadMeshWithChild,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadAnimMesh",mrb_xors3d_xLoadAnimMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateCube",mrb_xors3d_xCreateCube,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateSphere",mrb_xors3d_xCreateSphere,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateCylinder",mrb_xors3d_xCreateCylinder,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateTorus",mrb_xors3d_xCreateTorus,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateCone",mrb_xors3d_xCreateCone,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CopyMesh",mrb_xors3d_xCopyMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AddMesh",mrb_xors3d_xAddMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FlipMesh",mrb_xors3d_xFlipMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PaintMesh",mrb_xors3d_xPaintMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FitMesh",mrb_xors3d_xFitMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MeshWidth",mrb_xors3d_xMeshWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MeshHeight",mrb_xors3d_xMeshHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MeshDepth",mrb_xors3d_xMeshDepth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ScaleMesh",mrb_xors3d_xScaleMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RotateMesh",mrb_xors3d_xRotateMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PositionMesh",mrb_xors3d_xPositionMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"UpdateNormals",mrb_xors3d_xUpdateNormals,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"UpdateN",mrb_xors3d_xUpdateN,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"UpdateTB",mrb_xors3d_xUpdateTB,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MeshesBBIntersect",mrb_xors3d_xMeshesBBIntersect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MeshesIntersect",mrb_xors3d_xMeshesIntersect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMeshVB",mrb_xors3d_xGetMeshVB,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMeshIB",mrb_xors3d_xGetMeshIB,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMeshVBSize",mrb_xors3d_xGetMeshVBSize,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetMeshIBSize",mrb_xors3d_xGetMeshIBSize,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteMeshVB",mrb_xors3d_xDeleteMeshVB,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteMeshIB",mrb_xors3d_xDeleteMeshIB,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CountSurfaces",mrb_xors3d_xCountSurfaces,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetSurface",mrb_xors3d_xGetSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreatePivot",mrb_xors3d_xCreatePivot,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FindSurface",mrb_xors3d_xFindSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreatePoly",mrb_xors3d_xCreatePoly,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MeshSingleSurface",mrb_xors3d_xMeshSingleSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SaveMesh",mrb_xors3d_xSaveMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LightMesh",mrb_xors3d_xLightMesh,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MeshPrimitiveType",mrb_xors3d_xMeshPrimitiveType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticlePosition",mrb_xors3d_xParticlePosition,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleX",mrb_xors3d_xParticleX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleY",mrb_xors3d_xParticleY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleZ",mrb_xors3d_xParticleZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleVeclocity",mrb_xors3d_xParticleVeclocity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleVX",mrb_xors3d_xParticleVX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleVY",mrb_xors3d_xParticleVY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleVZ",mrb_xors3d_xParticleVZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleRotation",mrb_xors3d_xParticleRotation,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticlePitch",mrb_xors3d_xParticlePitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleYaw",mrb_xors3d_xParticleYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleRoll",mrb_xors3d_xParticleRoll,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleTorque",mrb_xors3d_xParticleTorque,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleTPitch",mrb_xors3d_xParticleTPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleTYaw",mrb_xors3d_xParticleTYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleTRoll",mrb_xors3d_xParticleTRoll,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleSetAlpha",mrb_xors3d_xParticleSetAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleGetAlpha",mrb_xors3d_xParticleGetAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleColor",mrb_xors3d_xParticleColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleRed",mrb_xors3d_xParticleRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleGreen",mrb_xors3d_xParticleGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleBlue",mrb_xors3d_xParticleBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleScale",mrb_xors3d_xParticleScale,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleSX",mrb_xors3d_xParticleSX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleSY",mrb_xors3d_xParticleSY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleScaleSpeed",mrb_xors3d_xParticleScaleSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleScaleSpeedX",mrb_xors3d_xParticleScaleSpeedX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ParticleScaleSpeedY",mrb_xors3d_xParticleScaleSpeedY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddDummyShape",mrb_xors3d_xEntityAddDummyShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddBoxShape",mrb_xors3d_xEntityAddBoxShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddSphereShape",mrb_xors3d_xEntityAddSphereShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddCapsuleShape",mrb_xors3d_xEntityAddCapsuleShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddConeShape",mrb_xors3d_xEntityAddConeShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddCylinderShape",mrb_xors3d_xEntityAddCylinderShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddTriMeshShape",mrb_xors3d_xEntityAddTriMeshShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddTriMeshShapeProxy",mrb_xors3d_xEntityAddTriMeshShapeProxy,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddConvexShape",mrb_xors3d_xEntityAddConvexShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddConvexShapeProxy",mrb_xors3d_xEntityAddConvexShapeProxy,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddConcaveShape",mrb_xors3d_xEntityAddConcaveShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddConcaveShapeProxy",mrb_xors3d_xEntityAddConcaveShapeProxy,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddTerrainShape",mrb_xors3d_xEntityAddTerrainShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAttachBody",mrb_xors3d_xEntityAttachBody,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityDetachBody",mrb_xors3d_xEntityDetachBody,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeEntityBody",mrb_xors3d_xFreeEntityBody,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddCompoundShape",mrb_xors3d_xEntityAddCompoundShape,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundAddBox",mrb_xors3d_xEntityCompoundAddBox,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundAddSphere",mrb_xors3d_xEntityCompoundAddSphere,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundAddCapsule",mrb_xors3d_xEntityCompoundAddCapsule,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundAddCone",mrb_xors3d_xEntityCompoundAddCone,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundAddCylinder",mrb_xors3d_xEntityCompoundAddCylinder,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundCountChildren",mrb_xors3d_xEntityCompoundCountChildren,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundRemoveChild",mrb_xors3d_xEntityCompoundRemoveChild,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildSetPosition",mrb_xors3d_xEntityCompoundChildSetPosition,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildGetX",mrb_xors3d_xEntityCompoundChildGetX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildGetY",mrb_xors3d_xEntityCompoundChildGetY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildGetZ",mrb_xors3d_xEntityCompoundChildGetZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildSetRotation",mrb_xors3d_xEntityCompoundChildSetRotation,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildGetPitch",mrb_xors3d_xEntityCompoundChildGetPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildGetYaw",mrb_xors3d_xEntityCompoundChildGetYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCompoundChildGetRoll",mrb_xors3d_xEntityCompoundChildGetRoll,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateHingeJoint",mrb_xors3d_xCreateHingeJoint,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateBallJoint",mrb_xors3d_xCreateBallJoint,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateD6Joint",mrb_xors3d_xCreateD6Joint,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateD6SpringJoint",mrb_xors3d_xCreateD6SpringJoint,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointHingeGetAngle",mrb_xors3d_xJointHingeGetAngle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetPitchAngle",mrb_xors3d_xJointD6GetPitchAngle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetYawAngle",mrb_xors3d_xJointD6GetYawAngle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetRollAngle",mrb_xors3d_xJointD6GetRollAngle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetAngle",mrb_xors3d_xJointD6GetAngle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointDisableCollisions",mrb_xors3d_xJointDisableCollisions,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointEnable",mrb_xors3d_xJointEnable,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointIsEnabled",mrb_xors3d_xJointIsEnabled,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointGetImpulse",mrb_xors3d_xJointGetImpulse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeJoint",mrb_xors3d_xFreeJoint,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointBallSetPivot",mrb_xors3d_xJointBallSetPivot,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointBallGetPivotX",mrb_xors3d_xJointBallGetPivotX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointBallGetPivotY",mrb_xors3d_xJointBallGetPivotY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointBallGetPivotZ",mrb_xors3d_xJointBallGetPivotZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SetLimits",mrb_xors3d_xJointD6SetLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SetLowerLinearLimits",mrb_xors3d_xJointD6SetLowerLinearLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SetUpperLinearLimits",mrb_xors3d_xJointD6SetUpperLinearLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SetLowerAngularLimits",mrb_xors3d_xJointD6SetLowerAngularLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SetUpperAngularLimits",mrb_xors3d_xJointD6SetUpperAngularLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SetLinearLimits",mrb_xors3d_xJointD6SetLinearLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SetAngularLimits",mrb_xors3d_xJointD6SetAngularLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetLinearLowerX",mrb_xors3d_xJointD6GetLinearLowerX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetLinearLowerY",mrb_xors3d_xJointD6GetLinearLowerY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetLinearLowerZ",mrb_xors3d_xJointD6GetLinearLowerZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetLinearUpperX",mrb_xors3d_xJointD6GetLinearUpperX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetLinearUpperY",mrb_xors3d_xJointD6GetLinearUpperY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetLinearUpperZ",mrb_xors3d_xJointD6GetLinearUpperZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetAngularLowerX",mrb_xors3d_xJointD6GetAngularLowerX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetAngularLowerY",mrb_xors3d_xJointD6GetAngularLowerY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetAngularLowerZ",mrb_xors3d_xJointD6GetAngularLowerZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetAngularUpperX",mrb_xors3d_xJointD6GetAngularUpperX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetAngularUpperY",mrb_xors3d_xJointD6GetAngularUpperY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6GetAngularUpperZ",mrb_xors3d_xJointD6GetAngularUpperZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointD6SpringSetParam",mrb_xors3d_xJointD6SpringSetParam,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointHingeSetAxis",mrb_xors3d_xJointHingeSetAxis,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointHingeSetLimits",mrb_xors3d_xJointHingeSetLimits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointHingeGetLowerLimit",mrb_xors3d_xJointHingeGetLowerLimit,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointHingeGetUpperLimit",mrb_xors3d_xJointHingeGetUpperLimit,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointEnableMotor",mrb_xors3d_xJointEnableMotor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointHingeSetMotorTarget",mrb_xors3d_xJointHingeSetMotorTarget,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointGetEntityA",mrb_xors3d_xJointGetEntityA,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"JointGetEntityB",mrb_xors3d_xJointGetEntityB,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityApplyCentralForce",mrb_xors3d_xEntityApplyCentralForce,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityApplyCentralImpulse",mrb_xors3d_xEntityApplyCentralImpulse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityApplyTorque",mrb_xors3d_xEntityApplyTorque,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityApplyTorqueImpulse",mrb_xors3d_xEntityApplyTorqueImpulse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityApplyForce",mrb_xors3d_xEntityApplyForce,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityApplyImpulse",mrb_xors3d_xEntityApplyImpulse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityReleaseForces",mrb_xors3d_xEntityReleaseForces,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WorldSetGravity",mrb_xors3d_xWorldSetGravity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WorldGetGravityX",mrb_xors3d_xWorldGetGravityX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WorldGetGravityY",mrb_xors3d_xWorldGetGravityY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WorldGetGravityZ",mrb_xors3d_xWorldGetGravityZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetGravity",mrb_xors3d_xEntitySetGravity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetGravityX",mrb_xors3d_xEntityGetGravityX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetGravityY",mrb_xors3d_xEntityGetGravityY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetGravityZ",mrb_xors3d_xEntityGetGravityZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetLinearVelocity",mrb_xors3d_xEntitySetLinearVelocity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearVelocityX",mrb_xors3d_xEntityGetLinearVelocityX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearVelocityY",mrb_xors3d_xEntityGetLinearVelocityY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearVelocityZ",mrb_xors3d_xEntityGetLinearVelocityZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetAngularVelocity",mrb_xors3d_xEntitySetAngularVelocity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularVelocityX",mrb_xors3d_xEntityGetAngularVelocityX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularVelocityY",mrb_xors3d_xEntityGetAngularVelocityY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularVelocityZ",mrb_xors3d_xEntityGetAngularVelocityZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetDamping",mrb_xors3d_xEntitySetDamping,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearDamping",mrb_xors3d_xEntityGetLinearDamping,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularDamping",mrb_xors3d_xEntityGetAngularDamping,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetFriction",mrb_xors3d_xEntitySetFriction,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetFriction",mrb_xors3d_xEntityGetFriction,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetAnisotropicFriction",mrb_xors3d_xEntitySetAnisotropicFriction,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAnisotropicFrictionX",mrb_xors3d_xEntityGetAnisotropicFrictionX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAnisotropicFrictionY",mrb_xors3d_xEntityGetAnisotropicFrictionY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAnisotropicFrictionZ",mrb_xors3d_xEntityGetAnisotropicFrictionZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetLinearFactor",mrb_xors3d_xEntitySetLinearFactor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearFactorX",mrb_xors3d_xEntityGetLinearFactorX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearFactorY",mrb_xors3d_xEntityGetLinearFactorY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearFactorZ",mrb_xors3d_xEntityGetLinearFactorZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetAngularFactor",mrb_xors3d_xEntitySetAngularFactor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularFactorX",mrb_xors3d_xEntityGetAngularFactorX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularFactorY",mrb_xors3d_xEntityGetAngularFactorY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularFactorZ",mrb_xors3d_xEntityGetAngularFactorZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetRestitution",mrb_xors3d_xEntitySetRestitution,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetRestitution",mrb_xors3d_xEntityGetRestitution,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetMass",mrb_xors3d_xEntitySetMass,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetMass",mrb_xors3d_xEntityGetMass,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCountContacts",mrb_xors3d_xEntityCountContacts,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactX",mrb_xors3d_xEntityGetContactX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactY",mrb_xors3d_xEntityGetContactY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactZ",mrb_xors3d_xEntityGetContactZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactNX",mrb_xors3d_xEntityGetContactNX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactNY",mrb_xors3d_xEntityGetContactNY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactNZ",mrb_xors3d_xEntityGetContactNZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactDistance",mrb_xors3d_xEntityGetContactDistance,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContact",mrb_xors3d_xEntityGetContact,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactImpulse",mrb_xors3d_xEntityGetContactImpulse,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetCollisionGroup",mrb_xors3d_xEntitySetCollisionGroup,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetCollisionGroup",mrb_xors3d_xEntityGetCollisionGroup,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetContactGroup",mrb_xors3d_xEntitySetContactGroup,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetContactGroup",mrb_xors3d_xEntityGetContactGroup,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetRaycastGroup",mrb_xors3d_xEntitySetRaycastGroup,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetRaycastGroup",mrb_xors3d_xEntityGetRaycastGroup,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsSetCollisionFilter",mrb_xors3d_xPhysicsSetCollisionFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetCollisionFilter",mrb_xors3d_xPhysicsGetCollisionFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsSetContactFilter",mrb_xors3d_xPhysicsSetContactFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetContactFilter",mrb_xors3d_xPhysicsGetContactFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsSetRaycastFilter",mrb_xors3d_xPhysicsSetRaycastFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetRaycastFilter",mrb_xors3d_xPhysicsGetRaycastFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityIsSleeping",mrb_xors3d_xEntityIsSleeping,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityDisableSleeping",mrb_xors3d_xEntityDisableSleeping,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWakeUp",mrb_xors3d_xEntityWakeUp,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySleep",mrb_xors3d_xEntitySleep,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntitySetSleepingThresholds",mrb_xors3d_xEntitySetSleepingThresholds,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetLinearSleepingThreshold",mrb_xors3d_xEntityGetLinearSleepingThreshold,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityGetAngularSleepingThreshold",mrb_xors3d_xEntityGetAngularSleepingThreshold,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsRayCast",mrb_xors3d_xPhysicsRayCast,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitEntity",mrb_xors3d_xPhysicsGetHitEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitPointX",mrb_xors3d_xPhysicsGetHitPointX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitPointY",mrb_xors3d_xPhysicsGetHitPointY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitPointZ",mrb_xors3d_xPhysicsGetHitPointZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitNormalX",mrb_xors3d_xPhysicsGetHitNormalX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitNormalY",mrb_xors3d_xPhysicsGetHitNormalY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitNormalZ",mrb_xors3d_xPhysicsGetHitNormalZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsGetHitDistance",mrb_xors3d_xPhysicsGetHitDistance,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsCountHits",mrb_xors3d_xPhysicsCountHits,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityBodyLocalPosition",mrb_xors3d_xEntityBodyLocalPosition,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityBodyLocalRotation",mrb_xors3d_xEntityBodyLocalRotation,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityBodyLocalScale",mrb_xors3d_xEntityBodyLocalScale,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"WorldSetFrequency",mrb_xors3d_xWorldSetFrequency,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityMakeKinematic",mrb_xors3d_xEntityMakeKinematic,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityIsKinematic",mrb_xors3d_xEntityIsKinematic,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PhysicsDebugRender",mrb_xors3d_xPhysicsDebugRender,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityDisableSimulation",mrb_xors3d_xEntityDisableSimulation,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityHasBody",mrb_xors3d_xEntityHasBody,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCreateVehicle",mrb_xors3d_xEntityCreateVehicle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityFreeVehicle",mrb_xors3d_xEntityFreeVehicle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCountWheels",mrb_xors3d_xEntityCountWheels,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityAddWheel",mrb_xors3d_xEntityAddWheel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetRadius",mrb_xors3d_xEntityWheelSetRadius,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetAxle",mrb_xors3d_xEntityWheelSetAxle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetRay",mrb_xors3d_xEntityWheelSetRay,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetSuspensionLength",mrb_xors3d_xEntityWheelSetSuspensionLength,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetBrake",mrb_xors3d_xEntityWheelSetBrake,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetMaxSuspensionForce",mrb_xors3d_xEntityWheelSetMaxSuspensionForce,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetMaxSuspensionTravel",mrb_xors3d_xEntityWheelSetMaxSuspensionTravel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetSuspensionStiffness",mrb_xors3d_xEntityWheelSetSuspensionStiffness,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetSuspensionDamping",mrb_xors3d_xEntityWheelSetSuspensionDamping,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetSuspensionCompression",mrb_xors3d_xEntityWheelSetSuspensionCompression,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetFriction",mrb_xors3d_xEntityWheelSetFriction,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetEngineForce",mrb_xors3d_xEntityWheelSetEngineForce,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetRollInfluence",mrb_xors3d_xEntityWheelSetRollInfluence,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetRotation",mrb_xors3d_xEntityWheelSetRotation,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetSteering",mrb_xors3d_xEntityWheelSetSteering,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelSetConnectionPoint",mrb_xors3d_xEntityWheelSetConnectionPoint,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelGetSuspensionLength",mrb_xors3d_xEntityWheelGetSuspensionLength,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelGetPitch",mrb_xors3d_xEntityWheelGetPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelGetYaw",mrb_xors3d_xEntityWheelGetYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelGetRoll",mrb_xors3d_xEntityWheelGetRoll,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityWheelGetContactEntity",mrb_xors3d_xEntityWheelGetContactEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadPostEffect",mrb_xors3d_xLoadPostEffect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreePostEffect",mrb_xors3d_xFreePostEffect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetPostEffect",mrb_xors3d_xSetPostEffect,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RenderPostEffects",mrb_xors3d_xRenderPostEffects,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetPostEffectInt",mrb_xors3d_xSetPostEffectInt,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetPostEffectFloat",mrb_xors3d_xSetPostEffectFloat,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetPostEffectBool",mrb_xors3d_xSetPostEffectBool,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetPostEffectVector",mrb_xors3d_xSetPostEffectVector,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetPostEffectTexture",mrb_xors3d_xSetPostEffectTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeletePostEffectConstant",mrb_xors3d_xDeletePostEffectConstant,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearPostEffectConstants",mrb_xors3d_xClearPostEffectConstants,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreatePSystem",mrb_xors3d_xCreatePSystem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemType",mrb_xors3d_xPSystemType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetBlend",mrb_xors3d_xPSystemSetBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetBlend",mrb_xors3d_xPSystemGetBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetMaxParticles",mrb_xors3d_xPSystemSetMaxParticles,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetMaxParticles",mrb_xors3d_xPSystemGetMaxParticles,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetEmitterLifetime",mrb_xors3d_xPSystemSetEmitterLifetime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetEmitterLifetime",mrb_xors3d_xPSystemGetEmitterLifetime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetParticleLifetime",mrb_xors3d_xPSystemSetParticleLifetime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetParticleLifetime",mrb_xors3d_xPSystemGetParticleLifetime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetCreationInterval",mrb_xors3d_xPSystemSetCreationInterval,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetCreationInterval",mrb_xors3d_xPSystemGetCreationInterval,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetCreationFrequency",mrb_xors3d_xPSystemSetCreationFrequency,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetCreationFrequency",mrb_xors3d_xPSystemGetCreationFrequency,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetTexture",mrb_xors3d_xPSystemSetTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTexture",mrb_xors3d_xPSystemGetTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTextureFrames",mrb_xors3d_xPSystemGetTextureFrames,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTextureAnimationSpeed",mrb_xors3d_xPSystemGetTextureAnimationSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetOffset",mrb_xors3d_xPSystemSetOffset,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetOffsetMinX",mrb_xors3d_xPSystemGetOffsetMinX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetOffsetMinY",mrb_xors3d_xPSystemGetOffsetMinY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetOffsetMinZ",mrb_xors3d_xPSystemGetOffsetMinZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetOffsetMaxX",mrb_xors3d_xPSystemGetOffsetMaxX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetOffsetMaxY",mrb_xors3d_xPSystemGetOffsetMaxY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetOffsetMaxZ",mrb_xors3d_xPSystemGetOffsetMaxZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetVelocity",mrb_xors3d_xPSystemSetVelocity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetVelocityMinX",mrb_xors3d_xPSystemGetVelocityMinX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetVelocityMinY",mrb_xors3d_xPSystemGetVelocityMinY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetVelocityMinZ",mrb_xors3d_xPSystemGetVelocityMinZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetVelocityMaxX",mrb_xors3d_xPSystemGetVelocityMaxX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetVelocityMaxY",mrb_xors3d_xPSystemGetVelocityMaxY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetVelocityMaxZ",mrb_xors3d_xPSystemGetVelocityMaxZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemEnableFixedQuads",mrb_xors3d_xPSystemEnableFixedQuads,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemFixedQuadsUsed",mrb_xors3d_xPSystemFixedQuadsUsed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetTorque",mrb_xors3d_xPSystemSetTorque,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTorqueMinX",mrb_xors3d_xPSystemGetTorqueMinX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTorqueMinY",mrb_xors3d_xPSystemGetTorqueMinY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTorqueMinZ",mrb_xors3d_xPSystemGetTorqueMinZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTorqueMaxX",mrb_xors3d_xPSystemGetTorqueMaxX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTorqueMaxY",mrb_xors3d_xPSystemGetTorqueMaxY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetTorqueMaxZ",mrb_xors3d_xPSystemGetTorqueMaxZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetGravity",mrb_xors3d_xPSystemSetGravity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetGravity",mrb_xors3d_xPSystemGetGravity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetAlpha",mrb_xors3d_xPSystemSetAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetAlpha",mrb_xors3d_xPSystemGetAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetFadeSpeed",mrb_xors3d_xPSystemSetFadeSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetFadeSpeed",mrb_xors3d_xPSystemGetFadeSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetParticleSize",mrb_xors3d_xPSystemSetParticleSize,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetSizeMinX",mrb_xors3d_xPSystemGetSizeMinX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetSizeMinY",mrb_xors3d_xPSystemGetSizeMinY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetSizeMaxX",mrb_xors3d_xPSystemGetSizeMaxX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetSizeMaxY",mrb_xors3d_xPSystemGetSizeMaxY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetScaleSpeed",mrb_xors3d_xPSystemSetScaleSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetScaleSpeedMinX",mrb_xors3d_xPSystemGetScaleSpeedMinX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetScaleSpeedMinY",mrb_xors3d_xPSystemGetScaleSpeedMinY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetScaleSpeedMaxX",mrb_xors3d_xPSystemGetScaleSpeedMaxX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetScaleSpeedMaxY",mrb_xors3d_xPSystemGetScaleSpeedMaxY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetAngles",mrb_xors3d_xPSystemSetAngles,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetAnglesMinX",mrb_xors3d_xPSystemGetAnglesMinX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetAnglesMinY",mrb_xors3d_xPSystemGetAnglesMinY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetAnglesMinZ",mrb_xors3d_xPSystemGetAnglesMinZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetAnglesMaxX",mrb_xors3d_xPSystemGetAnglesMaxX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetAnglesMaxY",mrb_xors3d_xPSystemGetAnglesMaxY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetAnglesMaxZ",mrb_xors3d_xPSystemGetAnglesMaxZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetColorMode",mrb_xors3d_xPSystemSetColorMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetColorMode",mrb_xors3d_xPSystemGetColorMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetColors",mrb_xors3d_xPSystemSetColors,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetBeginColorRed",mrb_xors3d_xPSystemGetBeginColorRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetBeginColorGreen",mrb_xors3d_xPSystemGetBeginColorGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetBeginColorBlue",mrb_xors3d_xPSystemGetBeginColorBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetEndColorRed",mrb_xors3d_xPSystemGetEndColorRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetEndColorGreen",mrb_xors3d_xPSystemGetEndColorGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetEndColorBlue",mrb_xors3d_xPSystemGetEndColorBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreePSystem",mrb_xors3d_xFreePSystem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemSetParticleParenting",mrb_xors3d_xPSystemSetParticleParenting,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PSystemGetParticleParenting",mrb_xors3d_xPSystemGetParticleParenting,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LinePick",mrb_xors3d_xLinePick,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityPick",mrb_xors3d_xEntityPick,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraPick",mrb_xors3d_xCameraPick,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedNX",mrb_xors3d_xPickedNX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedNY",mrb_xors3d_xPickedNY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedNZ",mrb_xors3d_xPickedNZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedX",mrb_xors3d_xPickedX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedY",mrb_xors3d_xPickedY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedZ",mrb_xors3d_xPickedZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedEntity",mrb_xors3d_xPickedEntity,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedSurface",mrb_xors3d_xPickedSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedTriangle",mrb_xors3d_xPickedTriangle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PickedTime",mrb_xors3d_xPickedTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetShadowsBlur",mrb_xors3d_xSetShadowsBlur,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetShadowShader",mrb_xors3d_xSetShadowShader,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"InitShadows",mrb_xors3d_xInitShadows,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetShadowParams",mrb_xors3d_xSetShadowParams,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RenderShadows",mrb_xors3d_xRenderShadows,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ShadowPriority",mrb_xors3d_xShadowPriority,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraDisableShadows",mrb_xors3d_xCameraDisableShadows,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CameraEnableShadows",mrb_xors3d_xCameraEnableShadows,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityCastShadows",mrb_xors3d_xEntityCastShadows,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityReceiveShadows",mrb_xors3d_xEntityReceiveShadows,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityIsCaster",mrb_xors3d_xEntityIsCaster,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EntityIsReceiver",mrb_xors3d_xEntityIsReceiver,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadSound",mrb_xors3d_xLoadSound,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"Load3DSound",mrb_xors3d_xLoad3DSound,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeSound",mrb_xors3d_xFreeSound,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoopSound",mrb_xors3d_xLoopSound,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SoundPitch",mrb_xors3d_xSoundPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SoundVolume",mrb_xors3d_xSoundVolume,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SoundPan",mrb_xors3d_xSoundPan,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PlaySound",mrb_xors3d_xPlaySound,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"StopChannel",mrb_xors3d_xStopChannel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PauseChannel",mrb_xors3d_xPauseChannel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ResumeChannel",mrb_xors3d_xResumeChannel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PlayMusic",mrb_xors3d_xPlayMusic,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ChannelPitch",mrb_xors3d_xChannelPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ChannelVolume",mrb_xors3d_xChannelVolume,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ChannelPan",mrb_xors3d_xChannelPan,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ChannelPlaying",mrb_xors3d_xChannelPlaying,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"EmitSound",mrb_xors3d_xEmitSound,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateListener",mrb_xors3d_xCreateListener,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetListener",mrb_xors3d_xGetListener,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"InitalizeSound",mrb_xors3d_xInitalizeSound,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateSprite",mrb_xors3d_xCreateSprite,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SpriteViewMode",mrb_xors3d_xSpriteViewMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"HandleSprite",mrb_xors3d_xHandleSprite,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadSprite",mrb_xors3d_xLoadSprite,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RotateSprite",mrb_xors3d_xRotateSprite,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ScaleSprite",mrb_xors3d_xScaleSprite,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateSurface",mrb_xors3d_xCreateSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetSurfaceBrush",mrb_xors3d_xGetSurfaceBrush,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AddVertex",mrb_xors3d_xAddVertex,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"AddTriangle",mrb_xors3d_xAddTriangle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetSurfaceFrustumSphere",mrb_xors3d_xSetSurfaceFrustumSphere,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexCoords",mrb_xors3d_xVertexCoords,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexNormal",mrb_xors3d_xVertexNormal,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexTangent",mrb_xors3d_xVertexTangent,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexBinormal",mrb_xors3d_xVertexBinormal,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexColor",mrb_xors3d_xVertexColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexTexCoords",mrb_xors3d_xVertexTexCoords,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CountVertices",mrb_xors3d_xCountVertices,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexX",mrb_xors3d_xVertexX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexY",mrb_xors3d_xVertexY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexZ",mrb_xors3d_xVertexZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexNX",mrb_xors3d_xVertexNX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexNY",mrb_xors3d_xVertexNY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexNZ",mrb_xors3d_xVertexNZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexTX",mrb_xors3d_xVertexTX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexTY",mrb_xors3d_xVertexTY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexTZ",mrb_xors3d_xVertexTZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexBX",mrb_xors3d_xVertexBX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexBY",mrb_xors3d_xVertexBY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexBZ",mrb_xors3d_xVertexBZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexU",mrb_xors3d_xVertexU,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexV",mrb_xors3d_xVertexV,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexW",mrb_xors3d_xVertexW,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexRed",mrb_xors3d_xVertexRed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexGreen",mrb_xors3d_xVertexGreen,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexBlue",mrb_xors3d_xVertexBlue,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VertexAlpha",mrb_xors3d_xVertexAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TriangleVertex",mrb_xors3d_xTriangleVertex,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CountTriangles",mrb_xors3d_xCountTriangles,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PaintSurface",mrb_xors3d_xPaintSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearSurface",mrb_xors3d_xClearSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetSurfaceTexture",mrb_xors3d_xGetSurfaceTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeSurface",mrb_xors3d_xFreeSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfacePrimitiveType",mrb_xors3d_xSurfacePrimitiveType,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceTexture",mrb_xors3d_xSurfaceTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceColor",mrb_xors3d_xSurfaceColor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceAlpha",mrb_xors3d_xSurfaceAlpha,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceShininess",mrb_xors3d_xSurfaceShininess,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceBlend",mrb_xors3d_xSurfaceBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceFX",mrb_xors3d_xSurfaceFX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceAlphaRef",mrb_xors3d_xSurfaceAlphaRef,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SurfaceAlphaFunc",mrb_xors3d_xSurfaceAlphaFunc,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CPUName",mrb_xors3d_xCPUName,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CPUVendor",mrb_xors3d_xCPUVendor,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CPUFamily",mrb_xors3d_xCPUFamily,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CPUModel",mrb_xors3d_xCPUModel,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CPUStepping",mrb_xors3d_xCPUStepping,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CPUSpeed",mrb_xors3d_xCPUSpeed,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VideoInfo",mrb_xors3d_xVideoInfo,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VideoAspectRatio",mrb_xors3d_xVideoAspectRatio,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VideoAspectRatioStr",mrb_xors3d_xVideoAspectRatioStr,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTotalPhysMem",mrb_xors3d_xGetTotalPhysMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetAvailPhysMem",mrb_xors3d_xGetAvailPhysMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTotalPageMem",mrb_xors3d_xGetTotalPageMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetAvailPageMem",mrb_xors3d_xGetAvailPageMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTotalVidMem",mrb_xors3d_xGetTotalVidMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetAvailVidMem",mrb_xors3d_xGetAvailVidMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTotalVidLocalMem",mrb_xors3d_xGetTotalVidLocalMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetAvailVidLocalMem",mrb_xors3d_xGetAvailVidLocalMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTotalVidNonlocalMem",mrb_xors3d_xGetTotalVidNonlocalMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetAvailVidNonlocalMem",mrb_xors3d_xGetAvailVidNonlocalMem,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetXors3dVersion",mrb_xors3d_xGetXors3dVersion,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetXors3dMajorVersion",mrb_xors3d_xGetXors3dMajorVersion,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetXors3dMinorVersion",mrb_xors3d_xGetXors3dMinorVersion,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetXors3dRevision",mrb_xors3d_xGetXors3dRevision,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadTerrain",mrb_xors3d_xLoadTerrain,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateTerrain",mrb_xors3d_xCreateTerrain,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainShading",mrb_xors3d_xTerrainShading,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainHeight",mrb_xors3d_xTerrainHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainSize",mrb_xors3d_xTerrainSize,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainX",mrb_xors3d_xTerrainX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainY",mrb_xors3d_xTerrainY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainZ",mrb_xors3d_xTerrainZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ModifyTerrain",mrb_xors3d_xModifyTerrain,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainDetail",mrb_xors3d_xTerrainDetail,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainSplatting",mrb_xors3d_xTerrainSplatting,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadTerrainTexture",mrb_xors3d_xLoadTerrainTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeTerrainTexture",mrb_xors3d_xFreeTerrainTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainTextureLightmap",mrb_xors3d_xTerrainTextureLightmap,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainTexture",mrb_xors3d_xTerrainTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainViewZone",mrb_xors3d_xTerrainViewZone,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TerrainLODs",mrb_xors3d_xTerrainLODs,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureWidth",mrb_xors3d_xTextureWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureHeight",mrb_xors3d_xTextureHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateTexture",mrb_xors3d_xCreateTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"FreeTexture",mrb_xors3d_xFreeTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetTextureFilter",mrb_xors3d_xSetTextureFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureBlend",mrb_xors3d_xTextureBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureCoords",mrb_xors3d_xTextureCoords,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureFilter",mrb_xors3d_xTextureFilter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ClearTextureFilters",mrb_xors3d_xClearTextureFilters,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadTexture",mrb_xors3d_xLoadTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureName",mrb_xors3d_xTextureName,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"PositionTexture",mrb_xors3d_xPositionTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"ScaleTexture",mrb_xors3d_xScaleTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"RotateTexture",mrb_xors3d_xRotateTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"LoadAnimTexture",mrb_xors3d_xLoadAnimTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateTextureFromData",mrb_xors3d_xCreateTextureFromData,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureData",mrb_xors3d_xGetTextureData,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureDataPitch",mrb_xors3d_xGetTextureDataPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureSurface",mrb_xors3d_xGetTextureSurface,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureFrames",mrb_xors3d_xGetTextureFrames,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetCubeFace",mrb_xors3d_xSetCubeFace,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetCubeMode",mrb_xors3d_xSetCubeMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureBlend",mrb_xors3d_xGetTextureBlend,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureX",mrb_xors3d_xGetTextureX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureY",mrb_xors3d_xGetTextureY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureScaleX",mrb_xors3d_xGetTextureScaleX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureScaleY",mrb_xors3d_xGetTextureScaleY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureAngle",mrb_xors3d_xGetTextureAngle,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureCoords",mrb_xors3d_xGetTextureCoords,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetCubeFace",mrb_xors3d_xGetCubeFace,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetCubeMode",mrb_xors3d_xGetCubeMode,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetTextureFlags",mrb_xors3d_xGetTextureFlags,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetTextureFlags",mrb_xors3d_xSetTextureFlags,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TextureCounter",mrb_xors3d_xTextureCounter,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VectorPitch",mrb_xors3d_xVectorPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"VectorYaw",mrb_xors3d_xVectorYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeltaPitch",mrb_xors3d_xDeltaPitch,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeltaYaw",mrb_xors3d_xDeltaYaw,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TFormedX",mrb_xors3d_xTFormedX,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TFormedY",mrb_xors3d_xTFormedY,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TFormedZ",mrb_xors3d_xTFormedZ,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TFormPoint",mrb_xors3d_xTFormPoint,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TFormVector",mrb_xors3d_xTFormVector,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"TFormNormal",mrb_xors3d_xTFormNormal,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"OpenMovie",mrb_xors3d_xOpenMovie,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CloseMovie",mrb_xors3d_xCloseMovie,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DrawMovie",mrb_xors3d_xDrawMovie,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MovieWidth",mrb_xors3d_xMovieWidth,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MovieHeight",mrb_xors3d_xMovieHeight,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MoviePlaying",mrb_xors3d_xMoviePlaying,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MovieSeek",mrb_xors3d_xMovieSeek,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MovieLength",mrb_xors3d_xMovieLength,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MovieCurrentTime",mrb_xors3d_xMovieCurrentTime,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MoviePause",mrb_xors3d_xMoviePause,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MovieResume",mrb_xors3d_xMovieResume,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"MovieTexture",mrb_xors3d_xMovieTexture,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"CreateWorld",mrb_xors3d_xCreateWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"SetActiveWorld",mrb_xors3d_xSetActiveWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetActiveWorld",mrb_xors3d_xGetActiveWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"GetDefaultWorld",mrb_xors3d_xGetDefaultWorld,MRB_ARGS_ANY());
	XMRB_def(mrb,c,"DeleteWorld",mrb_xors3d_xDeleteWorld,MRB_ARGS_ANY());
}
